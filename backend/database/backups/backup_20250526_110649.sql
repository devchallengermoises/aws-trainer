...
INSERT INTO `exam_types` VALUES (1,'AWS Certified SysOps Administrator','SOA-C02','AWS Certified SysOps Administrator - Associate certification exam','2025-05-26 14:06:06','2025-05-26 14:06:06'),(2,'AWS Certified Solutions Architect','ASS-C03','AWS Certified Solutions Architect - Associate certification exam','2025-05-26 14:06:06','2025-05-26 14:06:06'),(3,'AWS Certified Developer','DVA-C02','AWS Certified Developer - Associate certification exam','2025-05-26 14:06:06','2025-05-26 14:06:06');
...
INSERT INTO `questions` VALUES (1,'A company hosts an internal application on Amazon EC2 On-Demand Instances behind an\n            Application Load Balancer (ALB). The instances are in an Amazon EC2 Auto Scaling group.\n            Employees use the application to provide product prices to potential customers. The Auto\n            Scaling group is configured with a dynamic scaling policy and tracks average CPU utilization of\n            the instances.\n            Employees have noticed that sometimes the application becomes slow or unresponsive. A\n            SysOps administrator finds that some instances are experiencing a high CPU load. The Auto\n            Scaling group cannot scale out because the company is reaching the EC2 instance service\n            quota.\n            The SysOps administrator needs to implement a solution that provides a notification when the\n            company reaches 70% or more of the EC2 instance service quota.\n            Which solution will meet these requirements in the MOST operationally efficient manner?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(2,'A company uses Amazon CloudFront to serve static content to end users. The company recently deployed updates to 150 images on the company\'s website. However, the website is not displaying some of the new images. A SysOps administrator reviews the CloudFront distribution\'s cache settings. The default TTL for the distribution is set to 1 week (604,800 seconds). What should the SysOps administrator do to refresh the cache with the new images in the MOST operationally efficient way?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(3,'A company has two VPC networks named VPC A and VPC B. The VPC A CIDR block is 10.0.0.0/16 and the VPC B CIDR block is 172.31.0.0/16. The company wants to establish a VPC peering connection named pcx-12345 between both VPCs. Which rules should appear in the route table of VPC A after configuration? (Select TWO)',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(4,'A SysOps administrator is maintaining a web application using an Amazon CloudFront web distribution, an Application Load Balancer (ALB), Amazon RDS, and Amazon EC2 in a VPC. All services have logging enabled. The administrator needs to investigate HTTP Layer 7 status codes from the web application. Which log sources contain the status codes? (Select TWO.)',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(5,'An errant process is known to use an entire processor and run at 100%. A SysOps administrator wants to automate restarting an Amazon EC2 instance when the problem occurs for more than 2 minutes. How can this be accomplished?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(6,'A SysOps administrator uses AWS Systems Manager Session Manager to connect to instances. After the SysOps administrator launches a new Amazon EC2 instance, the EC2 instance does not appear in the Session Manager list of systems that are available for connection. The SysOps administrator verifies that Systems Manager Agent is installed, updated, and running on the EC2 instance. What is the reason for this issue?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(7,'An e-commerce company uses an Amazon ElastiCache for Redis cluster for in-memory caching of popular product queries on a shopping website. The cache eviction policy is randomly evicting keys whether or not a TTL is set. A SysOps administrator must improve the cache hit ratio without increasing costs. Which solution will meet these requirements?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(8,'A company\'s social media application has strict data residency requirements. The company wants to use Amazon Route 53 to provide the application with DNS services. A SysOps administrator must implement a solution that routes requests to a defined list of AWS Regions. The routing must be based on the user\'s location. Which solution will meet these requirements?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(9,'A company stores critical data in Amazon S3 buckets. A SysOps administrator must build a solution to record all S3 API activity. Which action will meet this requirement?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(10,'A company runs its web application on multiple Amazon EC2 instances that are part of an Auto Scaling group. The company wants the Auto Scaling group to scale out as soon as CPU utilization rises above 50% for the instances. How should a SysOps administrator configure the Auto Scaling group to meet these requirements?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(11,'A company has a stateful web application that is hosted on Amazon EC2 instances in an Auto Scaling group. The instances run behind an Application Load Balancer (ALB) that has a single target group. The ALB is configured as the origin in an Amazon CloudFront distribution. Users are reporting random logouts from the web application. Which combination of actions should a SysOps administrator take to resolve this problem? (Select TWO.)',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(12,'A company has attached the following policy to an IAM user:\\n\\n{\\n\"Version\": \"2012-10-17\",\\n\"Statement\": [\\n{\\n\"Effect\": \"Allow\",\\n\"Action\": \"rds:Describe*\",\\n\"Resource\": \"*\"\\n},\\n{\\n\"Effect\": \"Allow\",\\n\"Action\": \"ec2:*\",\\n\"Resource\": \"*\",\\n\"Condition\": {\\n\"StringEquals\": {\\n\"ec2:Region\": \"us-east-1\"\\n}\\n}\\n},\\n{\\n\"Effect\": \"Deny\",\\n\"NotAction\": [\\n\"ec2:*\",\\n\"s3:GetObject\"\\n],\\n\"Resource\": \"*\"\\n}\\n]\\n}\\n\\nWhich of the following actions are allowed for the IAM user?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(13,'A company hosts a production MySQL database on an Amazon Aurora single-node DB cluster. The database is queried heavily for reporting purposes. The DB cluster is experiencing periods of performance degradation because of high CPU utilization and maximum connections errors. A SysOps administrator needs to improve the stability of the database. Which solution will meet these requirements?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(14,'A company needs to take an inventory of applications that are running on multiple Amazon EC2 instances using Systems Manager. An updated version of Systems Manager Agent has been installed and is running on every instance. While configuring an inventory collection, a SysOps administrator discovers that not all the instances in a single subnet are managed by Systems Manager. What must the SysOps administrator do to fix this issue?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(15,'A company manages its production applications across several AWS accounts. The company hosts the production applications on Amazon EC2 instances that run Amazon Linux 2. The EC2 instances are spread across multiple VPCs. Each VPC uses its own Amazon Route 53 private hosted zone for private DNS. A VPC from Account A needs to resolve private DNS records from a private hosted zone that is associated with a different VPC in Account B. What should a SysOps administrator do to meet these requirements?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(16,'A SysOps administrator configures an application to run on Amazon EC2 instances behind an Application Load Balancer (ALB) in a simple scaling Auto Scaling group with the default settings. The Auto Scaling group is configured to use the RequestCountPerTarget metric for scaling. The SysOps administrator notices that the RequestCountPerTarget metric exceeded the specified limit twice in 180 seconds. How will the number of EC2 instances in this Auto Scaling group be affected in this scenario?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(17,'A company uses an Amazon S3 bucket to store data files. The S3 bucket contains hundreds of objects. The company needs to replace a tag on all the objects in the S3 bucket with another tag. What is the MOST operationally efficient way to meet this requirement?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(18,'A company wants to use only IPv6 for all its Amazon EC2 instances. The EC2 instances must not be accessible from the internet, but the EC2 instances must be able to access the internet. The company creates a dual-stack VPC and IPv6-only subnets. How should a SysOps administrator configure the VPC to meet these requirements?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(19,'A company has an on-premises DNS solution and wants to resolve DNS records in an Amazon Route 53 private hosted zone for example.com. The company has set up an AWS Direct Connect connection for network connectivity between the on-premises network and the VPC. A SysOps administrator must ensure that an on-premises server can query records in the example.com domain. What should the SysOps administrator do to meet these requirements?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(20,'A company uses AWS CloudFormation templates to deploy cloud infrastructure. An analysis of all the company templates shows that the company has declared the same components in multiple templates. A SysOps administrator needs to create dedicated templates that have their own parameters and conditions for these common components. Which solution will meet this requirement?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(21,'A company is expanding globally and needs to back up data on Amazon Elastic Block Storage (Amazon EBS) volumes to a different AWS Region. Most of the EBS volumes that store the data are encrypted, but some of the EBS volumes are unencrypted. The company needs the backup data from all the EBS volumes to be encrypted. Which solution will meet these requirements with the LEAST management overhead?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(22,'A company needs to ensure that all objects uploaded to an Amazon S3 bucket are encrypted. The company wants to use server-side encryption with AWS Key Management Service (AWS KMS) keys (SSE-KMS). Which solution will meet this requirement?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(23,'A company is running a web application on Amazon EC2 instances behind an Application Load Balancer (ALB). The company wants to monitor the application for HTTP 5xx errors. Which AWS service should the company use to collect and analyze the error metrics?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(24,'A SysOps administrator launches an Amazon EC2 instance in a private subnet of a VPC. When the SysOps administrator attempts a curl command from the command line of the EC2 instance, the SysOps administrator cannot connect to https://www.example.com. What should the SysOps administrator do to resolve this issue?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(25,'A SysOps administrator has an AWS CloudFormation template that is used to deploy an encrypted Amazon Machine Image (AMI). The CloudFormation template will be used in a second account, so the SysOps administrator copies the encrypted AMI to the second account. When launching the new CloudFormation stack in the second account, it fails. Which action should the SysOps administrator take to correct the issue?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(26,'A company wants to apply an existing Amazon Route 53 private hosted zone to a new VPC to allow for customized resource name resolution within the VPC. The SysOps administrator created the VPC and added the appropriate resource record sets to the private hosted zone. Which step should the SysOps administrator take to complete the setup?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(27,'A SysOps administrator has created an AWS Service Catalog portfolio and has shared the portfolio with a second AWS account in the company. The second account is controlled by a different administrator. Which action will the administrator of the second account be able to perform?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(28,'A company runs a web application on three Amazon EC2 instances behind an Application Load Balancer (ALB). Web traffic increases significantly during the same 9-hour period every day and causes a decrease in the application’s performance. A SysOps administrator must scale the application ahead of the changes in demand to meet a service level agreement (SLA) for application latency. Which solution will meet these requirements?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(29,'A company runs a web application on three Amazon EC2 instances behind an Application Load Balancer (ALB). Web traffic increases significantly during the same 9-hour period every day and causes a decrease in the application’s performance. A SysOps administrator must scale the application ahead of the changes in demand to meet a service level agreement (SLA) for application latency. Which solution will meet these requirements?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(30,'A company wants to monitor the number of Amazon EC2 instances that it is running. The company also wants to automate a service quota increase when the number of instances reaches a specific threshold. Which solution meets these requirements?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(31,'A SysOps administrator is responsible for a legacy, CPU-heavy application. The application can only be scaled vertically. Currently, the application is deployed on a single t3.large Amazon EC2 instance. The system is showing 90% CPU usage and significant performance latency after a few minutes. What change should be made to alleviate the performance problem?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(32,'A SysOps administrator has an AWS CloudFormation template of the company\'s existing infrastructure in us-west-2. The administrator attempts to use the template to launch a new stack in eu-west-1, but the stack only partially deploys, receives an error message, and then rolls back. Why would this template fail to deploy? (Select TWO)',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(33,'A SysOps administrator is provisioning an Amazon Elastic File System (Amazon EFS) file system to provide shared storage across multiple Amazon EC2 instances. The instances all exist in the same VPC across multiple Availability Zones. There are two instances in each Availability Zone. The SysOps administrator must make the file system accessible to each instance with the lowest possible latency. Which solution will meet these requirements?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(34,'A SysOps administrator wants to upload a file that is 1 TB in size from on-premises to an Amazon S3 bucket using multipart uploads. What should the SysOps administrator do to meet this requirement?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(35,'A company runs its applications on a large number of Amazon EC2 instances. A SysOps administrator must implement a solution to notify the operations team whenever an EC2 instance state changes. What is the MOST operationally efficient solution that meets these requirements?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(36,'A company\'s security policy states that connecting to Amazon EC2 instances is not permitted through SSH and RDP. If access is required, authorized staff can connect to instances by using AWS Systems Manager Session Manager. Users report that they are unable to connect to one specific Amazon EC2 instance that is running Ubuntu and has AWS Systems Manager Agent (SSM Agent) pre-installed. These users are able to use Session Manager to connect to other instances in the same subnet, and they are in an IAM group that has Session Manager permission for all instances. What should a SysOps administrator do to resolve this issue?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(37,'A SysOps administrator has an Amazon S3 website and wants to restrict access to a single Amazon CloudFront distribution. Visitors to the website should not be able to circumvent CloudFront or view the S3 website directly from the bucket. Which AWS service or feature will meet these requirements?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(38,'A company has an Amazon EC2 instance that has high CPU utilization. The EC2 instance is a t3.large instance and is running a test web application. The company discovers that the web application would operate better on a compute optimized large instance. What should a SysOps administrator do to make this change?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(39,'A database is running on an Amazon RDS Multi-AZ DB instance. A recent security audit found the database to be out of compliance because it was not encrypted. Which approach will resolve the encryption requirement?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(40,'A company uploaded its website files to an Amazon S3 bucket that has S3 Versioning enabled. The company uses an Amazon CloudFront distribution with the S3 bucket as the origin. The company recently modified the files, but the object names remained the same. Users report that old content is still appearing on the website. How should a SysOps administrator remediate this issue?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(41,'A SysOps administrator has enabled AWS CloudTrail in an AWS account. If CloudTrail is disabled, it must be re-enabled immediately. What should the SysOps administrator do to meet these requirements WITHOUT writing custom code?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06'),(42,'A company\'s SysOps administrator uses AWS IAM Identity Center (AWS Single Sign-On) to connect to an Active Directory. The SysOps administrator creates a new account that all the company\'s users need to access. The SysOps administrator uses the Active Directory Domain Users group for permissions to the new account because all users are already members of the group. When users try to log in, their access is denied. Which action will resolve this access issue?',1,'2025-05-26 14:06:06','2025-05-26 14:06:06');
...
INSERT INTO `users` VALUES (1,'Admin!.!','admin@admin.com',NULL,'$2y$10$XtKF5uRyh6bJ1gGhCWAIuuLWN2JtJHJzepEWcfvvQHy6XAS.PzNXq',NULL,'2025-05-26 14:06:06','2025-05-26 14:06:06');
...
-- Dump completed on 2025-05-26 14:06:49
